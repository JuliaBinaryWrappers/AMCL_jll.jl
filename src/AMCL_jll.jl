...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import AMCL_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3d240a5b-71e6-5479-a1fd-1de0b877801d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "AMCL", artifacts_toml) for e in artifacts["AMCL"]]
...
if best_platform === nothing
    @debug("Unable to load AMCL; unsupported platform $(triplet(platform_key_abi()))")
else
