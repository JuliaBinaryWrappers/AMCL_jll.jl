# Autogenerated wrapper script for AMCL_jll for x86_64-w64-mingw32
...
const libamcl_pairing_BLS383_splitpath = ["bin", "libamcl_pairing_BLS383.dll"]
...
const libamcl_pairing_BLS383 = "libamcl_pairing_BLS383.dll"


# Relative path to `libamcl_curve_GOLDILOCKS`
const libamcl_curve_GOLDILOCKS_splitpath = ["bin", "libamcl_curve_GOLDILOCKS.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_GOLDILOCKS = "libamcl_curve_GOLDILOCKS.dll"


# Relative path to `libamcl_mpin_BLS24`
const libamcl_mpin_BLS24_splitpath = ["bin", "libamcl_mpin_BLS24.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BLS24 = "libamcl_mpin_BLS24.dll"


# Relative path to `libamcl_curve_NUMS256E`
const libamcl_curve_NUMS256E_splitpath = ["bin", "libamcl_curve_NUMS256E.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS256E = "libamcl_curve_NUMS256E.dll"


# Relative path to `libamcl_bls_BN254`
const libamcl_bls_BN254_splitpath = ["bin", "libamcl_bls_BN254.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BN254 = "libamcl_bls_BN254.dll"


# Relative path to `libamcl_curve_ED25519`
const libamcl_curve_ED25519_splitpath = ["bin", "libamcl_curve_ED25519.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_ED25519 = "libamcl_curve_ED25519.dll"


# Relative path to `libamcl_bls_BLS461`
const libamcl_bls_BLS461_splitpath = ["bin", "libamcl_bls_BLS461.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BLS461 = "libamcl_bls_BLS461.dll"


# Relative path to `libamcl_curve_NUMS384E`
const libamcl_curve_NUMS384E_splitpath = ["bin", "libamcl_curve_NUMS384E.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS384E = "libamcl_curve_NUMS384E.dll"


# Relative path to `libamcl_curve_NUMS512E`
const libamcl_curve_NUMS512E_splitpath = ["bin", "libamcl_curve_NUMS512E.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS512E = "libamcl_curve_NUMS512E.dll"


# Relative path to `libamcl_mpin_BLS383`
const libamcl_mpin_BLS383_splitpath = ["bin", "libamcl_mpin_BLS383.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BLS383 = "libamcl_mpin_BLS383.dll"


# Relative path to `libamcl_wcc_BLS48`
const libamcl_wcc_BLS48_splitpath = ["bin", "libamcl_wcc_BLS48.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BLS48 = "libamcl_wcc_BLS48.dll"


# Relative path to `libamcl_mpin_BLS461`
const libamcl_mpin_BLS461_splitpath = ["bin", "libamcl_mpin_BLS461.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BLS461 = "libamcl_mpin_BLS461.dll"


# Relative path to `libamcl_curve_BLS48`
const libamcl_curve_BLS48_splitpath = ["bin", "libamcl_curve_BLS48.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BLS48 = "libamcl_curve_BLS48.dll"


# Relative path to `libamcl_curve_SECP256K1`
const libamcl_curve_SECP256K1_splitpath = ["bin", "libamcl_curve_SECP256K1.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_SECP256K1 = "libamcl_curve_SECP256K1.dll"


# Relative path to `libamcl_pairing_BLS24`
const libamcl_pairing_BLS24_splitpath = ["bin", "libamcl_pairing_BLS24.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BLS24 = "libamcl_pairing_BLS24.dll"


# Relative path to `libamcl_curve_BN254CX`
const libamcl_curve_BN254CX_splitpath = ["bin", "libamcl_curve_BN254CX.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BN254CX = "libamcl_curve_BN254CX.dll"


# Relative path to `libamcl_curve_C41417`
const libamcl_curve_C41417_splitpath = ["bin", "libamcl_curve_C41417.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_C41417 = "libamcl_curve_C41417.dll"


# Relative path to `libamcl_mpin_BLS48`
const libamcl_mpin_BLS48_splitpath = ["bin", "libamcl_mpin_BLS48.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BLS48 = "libamcl_mpin_BLS48.dll"


# Relative path to `libamcl_mpin_BN254`
const libamcl_mpin_BN254_splitpath = ["bin", "libamcl_mpin_BN254.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BN254 = "libamcl_mpin_BN254.dll"


# Relative path to `libamcl_curve_NIST521`
const libamcl_curve_NIST521_splitpath = ["bin", "libamcl_curve_NIST521.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NIST521 = "libamcl_curve_NIST521.dll"


# Relative path to `libamcl_curve_NUMS512W`
const libamcl_curve_NUMS512W_splitpath = ["bin", "libamcl_curve_NUMS512W.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS512W = "libamcl_curve_NUMS512W.dll"


# Relative path to `libamcl_pairing_BN254`
const libamcl_pairing_BN254_splitpath = ["bin", "libamcl_pairing_BN254.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BN254 = "libamcl_pairing_BN254.dll"


# Relative path to `libamcl_curve_NUMS256W`
const libamcl_curve_NUMS256W_splitpath = ["bin", "libamcl_curve_NUMS256W.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS256W = "libamcl_curve_NUMS256W.dll"


# Relative path to `libamcl_bls_BLS381`
const libamcl_bls_BLS381_splitpath = ["bin", "libamcl_bls_BLS381.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BLS381 = "libamcl_bls_BLS381.dll"


# Relative path to `libamcl_mpin_FP256BN`
const libamcl_mpin_FP256BN_splitpath = ["bin", "libamcl_mpin_FP256BN.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_FP256BN = "libamcl_mpin_FP256BN.dll"


# Relative path to `libamcl_curve_BLS24`
const libamcl_curve_BLS24_splitpath = ["bin", "libamcl_curve_BLS24.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BLS24 = "libamcl_curve_BLS24.dll"


# Relative path to `libamcl_x509`
const libamcl_x509_splitpath = ["bin", "libamcl_x509.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_x509 = "libamcl_x509.dll"


# Relative path to `libamcl_curve_NIST384`
const libamcl_curve_NIST384_splitpath = ["bin", "libamcl_curve_NIST384.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NIST384 = "libamcl_curve_NIST384.dll"


# Relative path to `libamcl_pairing_BLS48`
const libamcl_pairing_BLS48_splitpath = ["bin", "libamcl_pairing_BLS48.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BLS48 = "libamcl_pairing_BLS48.dll"


# Relative path to `libamcl_bls_BLS24`
const libamcl_bls_BLS24_splitpath = ["bin", "libamcl_bls_BLS24.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BLS24 = "libamcl_bls_BLS24.dll"


# Relative path to `libamcl_bls_FP512BN`
const libamcl_bls_FP512BN_splitpath = ["bin", "libamcl_bls_FP512BN.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_FP512BN = "libamcl_bls_FP512BN.dll"


# Relative path to `libamcl_rsa_3072`
const libamcl_rsa_3072_splitpath = ["bin", "libamcl_rsa_3072.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_rsa_3072 = "libamcl_rsa_3072.dll"


# Relative path to `libamcl_bls_FP256BN`
const libamcl_bls_FP256BN_splitpath = ["bin", "libamcl_bls_FP256BN.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_FP256BN = "libamcl_bls_FP256BN.dll"


# Relative path to `libamcl_wcc_BLS383`
const libamcl_wcc_BLS383_splitpath = ["bin", "libamcl_wcc_BLS383.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BLS383 = "libamcl_wcc_BLS383.dll"


# Relative path to `libamcl_wcc_BN254CX`
const libamcl_wcc_BN254CX_splitpath = ["bin", "libamcl_wcc_BN254CX.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BN254CX = "libamcl_wcc_BN254CX.dll"


# Relative path to `libamcl_mpin_BN254CX`
const libamcl_mpin_BN254CX_splitpath = ["bin", "libamcl_mpin_BN254CX.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BN254CX = "libamcl_mpin_BN254CX.dll"


# Relative path to `libamcl_rsa_4096`
const libamcl_rsa_4096_splitpath = ["bin", "libamcl_rsa_4096.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_rsa_4096 = "libamcl_rsa_4096.dll"


# Relative path to `libamcl_pairing_BLS461`
const libamcl_pairing_BLS461_splitpath = ["bin", "libamcl_pairing_BLS461.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BLS461 = "libamcl_pairing_BLS461.dll"


# Relative path to `libamcl_mpin_FP512BN`
const libamcl_mpin_FP512BN_splitpath = ["bin", "libamcl_mpin_FP512BN.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_FP512BN = "libamcl_mpin_FP512BN.dll"


# Relative path to `libamcl_curve_NIST256`
const libamcl_curve_NIST256_splitpath = ["bin", "libamcl_curve_NIST256.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NIST256 = "libamcl_curve_NIST256.dll"


# Relative path to `libamcl_pairing_FP256BN`
const libamcl_pairing_FP256BN_splitpath = ["bin", "libamcl_pairing_FP256BN.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_FP256BN = "libamcl_pairing_FP256BN.dll"


# Relative path to `libamcl_wcc_FP512BN`
const libamcl_wcc_FP512BN_splitpath = ["bin", "libamcl_wcc_FP512BN.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_FP512BN = "libamcl_wcc_FP512BN.dll"


# Relative path to `libamcl_bls_BLS383`
const libamcl_bls_BLS383_splitpath = ["bin", "libamcl_bls_BLS383.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BLS383 = "libamcl_bls_BLS383.dll"


# Relative path to `libamcl_curve_BN254`
const libamcl_curve_BN254_splitpath = ["bin", "libamcl_curve_BN254.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BN254 = "libamcl_curve_BN254.dll"


# Relative path to `libamcl_wcc_BLS461`
const libamcl_wcc_BLS461_splitpath = ["bin", "libamcl_wcc_BLS461.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BLS461 = "libamcl_wcc_BLS461.dll"


# Relative path to `libamcl_curve_C25519`
const libamcl_curve_C25519_splitpath = ["bin", "libamcl_curve_C25519.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_C25519 = "libamcl_curve_C25519.dll"


# Relative path to `libamcl_curve_HIFIVE`
const libamcl_curve_HIFIVE_splitpath = ["bin", "libamcl_curve_HIFIVE.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_HIFIVE = "libamcl_curve_HIFIVE.dll"


# Relative path to `libamcl_mpin_BLS381`
const libamcl_mpin_BLS381_splitpath = ["bin", "libamcl_mpin_BLS381.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BLS381 = "libamcl_mpin_BLS381.dll"


# Relative path to `libamcl_curve_BLS383`
const libamcl_curve_BLS383_splitpath = ["bin", "libamcl_curve_BLS383.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BLS383 = "libamcl_curve_BLS383.dll"


# Relative path to `libamcl_curve_BRAINPOOL`
const libamcl_curve_BRAINPOOL_splitpath = ["bin", "libamcl_curve_BRAINPOOL.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BRAINPOOL = "libamcl_curve_BRAINPOOL.dll"


# Relative path to `libamcl_pairing_BN254CX`
const libamcl_pairing_BN254CX_splitpath = ["bin", "libamcl_pairing_BN254CX.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BN254CX = "libamcl_pairing_BN254CX.dll"


# Relative path to `libamcl_wcc_BN254`
const libamcl_wcc_BN254_splitpath = ["bin", "libamcl_wcc_BN254.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BN254 = "libamcl_wcc_BN254.dll"


# Relative path to `libamcl_curve_FP256BN`
const libamcl_curve_FP256BN_splitpath = ["bin", "libamcl_curve_FP256BN.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_FP256BN = "libamcl_curve_FP256BN.dll"


# Relative path to `libamcl_curve_BLS381`
const libamcl_curve_BLS381_splitpath = ["bin", "libamcl_curve_BLS381.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BLS381 = "libamcl_curve_BLS381.dll"


# Relative path to `libamcl_core`
const libamcl_core_splitpath = ["bin", "libamcl_core.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_core = "libamcl_core.dll"


# Relative path to `libamcl_curve_ANSSI`
const libamcl_curve_ANSSI_splitpath = ["bin", "libamcl_curve_ANSSI.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_ANSSI = "libamcl_curve_ANSSI.dll"


# Relative path to `libamcl_curve_BLS461`
const libamcl_curve_BLS461_splitpath = ["bin", "libamcl_curve_BLS461.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BLS461 = "libamcl_curve_BLS461.dll"


# Relative path to `libamcl_wcc_FP256BN`
const libamcl_wcc_FP256BN_splitpath = ["bin", "libamcl_wcc_FP256BN.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_FP256BN = "libamcl_wcc_FP256BN.dll"


# Relative path to `libamcl_bls_BLS48`
const libamcl_bls_BLS48_splitpath = ["bin", "libamcl_bls_BLS48.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BLS48 = "libamcl_bls_BLS48.dll"


# Relative path to `libamcl_curve_NUMS384W`
const libamcl_curve_NUMS384W_splitpath = ["bin", "libamcl_curve_NUMS384W.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS384W = "libamcl_curve_NUMS384W.dll"


# Relative path to `libamcl_wcc_BLS24`
const libamcl_wcc_BLS24_splitpath = ["bin", "libamcl_wcc_BLS24.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BLS24 = "libamcl_wcc_BLS24.dll"


# Relative path to `libamcl_curve_FP512BN`
const libamcl_curve_FP512BN_splitpath = ["bin", "libamcl_curve_FP512BN.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_FP512BN = "libamcl_curve_FP512BN.dll"


# Relative path to `libamcl_wcc_BLS381`
const libamcl_wcc_BLS381_splitpath = ["bin", "libamcl_wcc_BLS381.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BLS381 = "libamcl_wcc_BLS381.dll"


# Relative path to `libamcl_pairing_FP512BN`
const libamcl_pairing_FP512BN_splitpath = ["bin", "libamcl_pairing_FP512BN.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_FP512BN = "libamcl_pairing_FP512BN.dll"


# Relative path to `libamcl_bls_BN254CX`
const libamcl_bls_BN254CX_splitpath = ["bin", "libamcl_bls_BN254CX.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BN254CX = "libamcl_bls_BN254CX.dll"


# Relative path to `libamcl_rsa_2048`
const libamcl_rsa_2048_splitpath = ["bin", "libamcl_rsa_2048.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_rsa_2048 = "libamcl_rsa_2048.dll"


# Relative path to `libamcl_pairing_BLS381`
const libamcl_pairing_BLS381_splitpath = ["bin", "libamcl_pairing_BLS381.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BLS381 = "libamcl_pairing_BLS381.dll"
