# Autogenerated wrapper script for AMCL_jll for x86_64-apple-darwin14
...
const libamcl_pairing_BLS383_splitpath = ["lib", "libamcl_pairing_BLS383.2.0.1.dylib"]
...
const libamcl_pairing_BLS383 = "@rpath/libamcl_pairing_BLS383.2.dylib"


# Relative path to `libamcl_curve_GOLDILOCKS`
const libamcl_curve_GOLDILOCKS_splitpath = ["lib", "libamcl_curve_GOLDILOCKS.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_GOLDILOCKS = "@rpath/libamcl_curve_GOLDILOCKS.2.dylib"


# Relative path to `libamcl_mpin_BLS24`
const libamcl_mpin_BLS24_splitpath = ["lib", "libamcl_mpin_BLS24.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BLS24 = "@rpath/libamcl_mpin_BLS24.2.dylib"


# Relative path to `libamcl_curve_NUMS256E`
const libamcl_curve_NUMS256E_splitpath = ["lib", "libamcl_curve_NUMS256E.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS256E = "@rpath/libamcl_curve_NUMS256E.2.dylib"


# Relative path to `libamcl_bls_BN254`
const libamcl_bls_BN254_splitpath = ["lib", "libamcl_bls_BN254.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BN254 = "@rpath/libamcl_bls_BN254.2.dylib"


# Relative path to `libamcl_curve_ED25519`
const libamcl_curve_ED25519_splitpath = ["lib", "libamcl_curve_ED25519.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_ED25519 = "@rpath/libamcl_curve_ED25519.2.dylib"


# Relative path to `libamcl_bls_BLS461`
const libamcl_bls_BLS461_splitpath = ["lib", "libamcl_bls_BLS461.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BLS461 = "@rpath/libamcl_bls_BLS461.2.dylib"


# Relative path to `libamcl_curve_NUMS384E`
const libamcl_curve_NUMS384E_splitpath = ["lib", "libamcl_curve_NUMS384E.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS384E = "@rpath/libamcl_curve_NUMS384E.2.dylib"


# Relative path to `libamcl_curve_NUMS512E`
const libamcl_curve_NUMS512E_splitpath = ["lib", "libamcl_curve_NUMS512E.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS512E = "@rpath/libamcl_curve_NUMS512E.2.dylib"


# Relative path to `libamcl_mpin_BLS383`
const libamcl_mpin_BLS383_splitpath = ["lib", "libamcl_mpin_BLS383.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BLS383 = "@rpath/libamcl_mpin_BLS383.2.dylib"


# Relative path to `libamcl_wcc_BLS48`
const libamcl_wcc_BLS48_splitpath = ["lib", "libamcl_wcc_BLS48.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BLS48 = "@rpath/libamcl_wcc_BLS48.2.dylib"


# Relative path to `libamcl_mpin_BLS461`
const libamcl_mpin_BLS461_splitpath = ["lib", "libamcl_mpin_BLS461.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BLS461 = "@rpath/libamcl_mpin_BLS461.2.dylib"


# Relative path to `libamcl_curve_BLS48`
const libamcl_curve_BLS48_splitpath = ["lib", "libamcl_curve_BLS48.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BLS48 = "@rpath/libamcl_curve_BLS48.2.dylib"


# Relative path to `libamcl_curve_SECP256K1`
const libamcl_curve_SECP256K1_splitpath = ["lib", "libamcl_curve_SECP256K1.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_SECP256K1 = "@rpath/libamcl_curve_SECP256K1.2.dylib"


# Relative path to `libamcl_pairing_BLS24`
const libamcl_pairing_BLS24_splitpath = ["lib", "libamcl_pairing_BLS24.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BLS24 = "@rpath/libamcl_pairing_BLS24.2.dylib"


# Relative path to `libamcl_curve_BN254CX`
const libamcl_curve_BN254CX_splitpath = ["lib", "libamcl_curve_BN254CX.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BN254CX = "@rpath/libamcl_curve_BN254CX.2.dylib"


# Relative path to `libamcl_curve_C41417`
const libamcl_curve_C41417_splitpath = ["lib", "libamcl_curve_C41417.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_C41417 = "@rpath/libamcl_curve_C41417.2.dylib"


# Relative path to `libamcl_mpin_BLS48`
const libamcl_mpin_BLS48_splitpath = ["lib", "libamcl_mpin_BLS48.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BLS48 = "@rpath/libamcl_mpin_BLS48.2.dylib"


# Relative path to `libamcl_mpin_BN254`
const libamcl_mpin_BN254_splitpath = ["lib", "libamcl_mpin_BN254.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BN254 = "@rpath/libamcl_mpin_BN254.2.dylib"


# Relative path to `libamcl_curve_NIST521`
const libamcl_curve_NIST521_splitpath = ["lib", "libamcl_curve_NIST521.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NIST521 = "@rpath/libamcl_curve_NIST521.2.dylib"


# Relative path to `libamcl_curve_NUMS512W`
const libamcl_curve_NUMS512W_splitpath = ["lib", "libamcl_curve_NUMS512W.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS512W = "@rpath/libamcl_curve_NUMS512W.2.dylib"


# Relative path to `libamcl_pairing_BN254`
const libamcl_pairing_BN254_splitpath = ["lib", "libamcl_pairing_BN254.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BN254 = "@rpath/libamcl_pairing_BN254.2.dylib"


# Relative path to `libamcl_curve_NUMS256W`
const libamcl_curve_NUMS256W_splitpath = ["lib", "libamcl_curve_NUMS256W.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS256W = "@rpath/libamcl_curve_NUMS256W.2.dylib"


# Relative path to `libamcl_bls_BLS381`
const libamcl_bls_BLS381_splitpath = ["lib", "libamcl_bls_BLS381.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BLS381 = "@rpath/libamcl_bls_BLS381.2.dylib"


# Relative path to `libamcl_mpin_FP256BN`
const libamcl_mpin_FP256BN_splitpath = ["lib", "libamcl_mpin_FP256BN.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_FP256BN = "@rpath/libamcl_mpin_FP256BN.2.dylib"


# Relative path to `libamcl_curve_BLS24`
const libamcl_curve_BLS24_splitpath = ["lib", "libamcl_curve_BLS24.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BLS24 = "@rpath/libamcl_curve_BLS24.2.dylib"


# Relative path to `libamcl_x509`
const libamcl_x509_splitpath = ["lib", "libamcl_x509.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_x509 = "@rpath/libamcl_x509.2.dylib"


# Relative path to `libamcl_curve_NIST384`
const libamcl_curve_NIST384_splitpath = ["lib", "libamcl_curve_NIST384.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NIST384 = "@rpath/libamcl_curve_NIST384.2.dylib"


# Relative path to `libamcl_pairing_BLS48`
const libamcl_pairing_BLS48_splitpath = ["lib", "libamcl_pairing_BLS48.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BLS48 = "@rpath/libamcl_pairing_BLS48.2.dylib"


# Relative path to `libamcl_bls_BLS24`
const libamcl_bls_BLS24_splitpath = ["lib", "libamcl_bls_BLS24.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BLS24 = "@rpath/libamcl_bls_BLS24.2.dylib"


# Relative path to `libamcl_bls_FP512BN`
const libamcl_bls_FP512BN_splitpath = ["lib", "libamcl_bls_FP512BN.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_FP512BN = "@rpath/libamcl_bls_FP512BN.2.dylib"


# Relative path to `libamcl_rsa_3072`
const libamcl_rsa_3072_splitpath = ["lib", "libamcl_rsa_3072.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_rsa_3072 = "@rpath/libamcl_rsa_3072.2.dylib"


# Relative path to `libamcl_bls_FP256BN`
const libamcl_bls_FP256BN_splitpath = ["lib", "libamcl_bls_FP256BN.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_FP256BN = "@rpath/libamcl_bls_FP256BN.2.dylib"


# Relative path to `libamcl_wcc_BLS383`
const libamcl_wcc_BLS383_splitpath = ["lib", "libamcl_wcc_BLS383.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BLS383 = "@rpath/libamcl_wcc_BLS383.2.dylib"


# Relative path to `libamcl_wcc_BN254CX`
const libamcl_wcc_BN254CX_splitpath = ["lib", "libamcl_wcc_BN254CX.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BN254CX = "@rpath/libamcl_wcc_BN254CX.2.dylib"


# Relative path to `libamcl_mpin_BN254CX`
const libamcl_mpin_BN254CX_splitpath = ["lib", "libamcl_mpin_BN254CX.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BN254CX = "@rpath/libamcl_mpin_BN254CX.2.dylib"


# Relative path to `libamcl_rsa_4096`
const libamcl_rsa_4096_splitpath = ["lib", "libamcl_rsa_4096.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_rsa_4096 = "@rpath/libamcl_rsa_4096.2.dylib"


# Relative path to `libamcl_pairing_BLS461`
const libamcl_pairing_BLS461_splitpath = ["lib", "libamcl_pairing_BLS461.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BLS461 = "@rpath/libamcl_pairing_BLS461.2.dylib"


# Relative path to `libamcl_mpin_FP512BN`
const libamcl_mpin_FP512BN_splitpath = ["lib", "libamcl_mpin_FP512BN.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_FP512BN = "@rpath/libamcl_mpin_FP512BN.2.dylib"


# Relative path to `libamcl_curve_NIST256`
const libamcl_curve_NIST256_splitpath = ["lib", "libamcl_curve_NIST256.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NIST256 = "@rpath/libamcl_curve_NIST256.2.dylib"


# Relative path to `libamcl_pairing_FP256BN`
const libamcl_pairing_FP256BN_splitpath = ["lib", "libamcl_pairing_FP256BN.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_FP256BN = "@rpath/libamcl_pairing_FP256BN.2.dylib"


# Relative path to `libamcl_wcc_FP512BN`
const libamcl_wcc_FP512BN_splitpath = ["lib", "libamcl_wcc_FP512BN.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_FP512BN = "@rpath/libamcl_wcc_FP512BN.2.dylib"


# Relative path to `libamcl_bls_BLS383`
const libamcl_bls_BLS383_splitpath = ["lib", "libamcl_bls_BLS383.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BLS383 = "@rpath/libamcl_bls_BLS383.2.dylib"


# Relative path to `libamcl_curve_BN254`
const libamcl_curve_BN254_splitpath = ["lib", "libamcl_curve_BN254.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BN254 = "@rpath/libamcl_curve_BN254.2.dylib"


# Relative path to `libamcl_wcc_BLS461`
const libamcl_wcc_BLS461_splitpath = ["lib", "libamcl_wcc_BLS461.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BLS461 = "@rpath/libamcl_wcc_BLS461.2.dylib"


# Relative path to `libamcl_curve_C25519`
const libamcl_curve_C25519_splitpath = ["lib", "libamcl_curve_C25519.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_C25519 = "@rpath/libamcl_curve_C25519.2.dylib"


# Relative path to `libamcl_curve_HIFIVE`
const libamcl_curve_HIFIVE_splitpath = ["lib", "libamcl_curve_HIFIVE.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_HIFIVE = "@rpath/libamcl_curve_HIFIVE.2.dylib"


# Relative path to `libamcl_mpin_BLS381`
const libamcl_mpin_BLS381_splitpath = ["lib", "libamcl_mpin_BLS381.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_mpin_BLS381 = "@rpath/libamcl_mpin_BLS381.2.dylib"


# Relative path to `libamcl_curve_BLS383`
const libamcl_curve_BLS383_splitpath = ["lib", "libamcl_curve_BLS383.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BLS383 = "@rpath/libamcl_curve_BLS383.2.dylib"


# Relative path to `libamcl_curve_BRAINPOOL`
const libamcl_curve_BRAINPOOL_splitpath = ["lib", "libamcl_curve_BRAINPOOL.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BRAINPOOL = "@rpath/libamcl_curve_BRAINPOOL.2.dylib"


# Relative path to `libamcl_pairing_BN254CX`
const libamcl_pairing_BN254CX_splitpath = ["lib", "libamcl_pairing_BN254CX.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BN254CX = "@rpath/libamcl_pairing_BN254CX.2.dylib"


# Relative path to `libamcl_wcc_BN254`
const libamcl_wcc_BN254_splitpath = ["lib", "libamcl_wcc_BN254.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BN254 = "@rpath/libamcl_wcc_BN254.2.dylib"


# Relative path to `libamcl_curve_FP256BN`
const libamcl_curve_FP256BN_splitpath = ["lib", "libamcl_curve_FP256BN.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_FP256BN = "@rpath/libamcl_curve_FP256BN.2.dylib"


# Relative path to `libamcl_curve_BLS381`
const libamcl_curve_BLS381_splitpath = ["lib", "libamcl_curve_BLS381.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BLS381 = "@rpath/libamcl_curve_BLS381.2.dylib"


# Relative path to `libamcl_core`
const libamcl_core_splitpath = ["lib", "libamcl_core.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_core = "@rpath/libamcl_core.2.dylib"


# Relative path to `libamcl_curve_ANSSI`
const libamcl_curve_ANSSI_splitpath = ["lib", "libamcl_curve_ANSSI.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_ANSSI = "@rpath/libamcl_curve_ANSSI.2.dylib"


# Relative path to `libamcl_curve_BLS461`
const libamcl_curve_BLS461_splitpath = ["lib", "libamcl_curve_BLS461.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_BLS461 = "@rpath/libamcl_curve_BLS461.2.dylib"


# Relative path to `libamcl_wcc_FP256BN`
const libamcl_wcc_FP256BN_splitpath = ["lib", "libamcl_wcc_FP256BN.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_FP256BN = "@rpath/libamcl_wcc_FP256BN.2.dylib"


# Relative path to `libamcl_bls_BLS48`
const libamcl_bls_BLS48_splitpath = ["lib", "libamcl_bls_BLS48.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BLS48 = "@rpath/libamcl_bls_BLS48.2.dylib"


# Relative path to `libamcl_curve_NUMS384W`
const libamcl_curve_NUMS384W_splitpath = ["lib", "libamcl_curve_NUMS384W.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_NUMS384W = "@rpath/libamcl_curve_NUMS384W.2.dylib"


# Relative path to `libamcl_wcc_BLS24`
const libamcl_wcc_BLS24_splitpath = ["lib", "libamcl_wcc_BLS24.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BLS24 = "@rpath/libamcl_wcc_BLS24.2.dylib"


# Relative path to `libamcl_curve_FP512BN`
const libamcl_curve_FP512BN_splitpath = ["lib", "libamcl_curve_FP512BN.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_curve_FP512BN = "@rpath/libamcl_curve_FP512BN.2.dylib"


# Relative path to `libamcl_wcc_BLS381`
const libamcl_wcc_BLS381_splitpath = ["lib", "libamcl_wcc_BLS381.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_wcc_BLS381 = "@rpath/libamcl_wcc_BLS381.2.dylib"


# Relative path to `libamcl_pairing_FP512BN`
const libamcl_pairing_FP512BN_splitpath = ["lib", "libamcl_pairing_FP512BN.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_FP512BN = "@rpath/libamcl_pairing_FP512BN.2.dylib"


# Relative path to `libamcl_bls_BN254CX`
const libamcl_bls_BN254CX_splitpath = ["lib", "libamcl_bls_BN254CX.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_bls_BN254CX = "@rpath/libamcl_bls_BN254CX.2.dylib"


# Relative path to `libamcl_rsa_2048`
const libamcl_rsa_2048_splitpath = ["lib", "libamcl_rsa_2048.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_rsa_2048 = "@rpath/libamcl_rsa_2048.2.dylib"


# Relative path to `libamcl_pairing_BLS381`
const libamcl_pairing_BLS381_splitpath = ["lib", "libamcl_pairing_BLS381.2.0.1.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libamcl_pairing_BLS381 = "@rpath/libamcl_pairing_BLS381.2.dylib"
